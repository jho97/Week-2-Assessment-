...
const foodArr = [ 
    ...
    popularity: 10,
    rating: 10,
    tags: ['pasta', 'meatballs', 'red sauce']
    },
...
const filteredFood = foodArr.filter(pizzaObj => {
    return pizzaObj.tags.includes('dressing')
})
